...
$subject = new doctrineGraphvizMldGenerator();
...
$t->ok(
  $subject->generate($modelNames) instanceof doctrineGraphvizMldGenerator,
  "Test if generate return a object from type doctrineGraphvizMldGenerator"
);
...
$t->ok(
  $subject->flushBuffer($modelNames) instanceof doctrineGraphvizMldGenerator,
  "Test if ->flushBuffer() return a object from type doctrineGraphvizMldGenerator"
);
