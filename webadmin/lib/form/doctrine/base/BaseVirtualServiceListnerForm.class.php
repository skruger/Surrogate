...
/**
 * VirtualServiceListner form base class.
 *
 * @method VirtualServiceListner getObject() Returns the current form's model object
 *
 * @package    webadmin
 * @subpackage form
 ...
 */
abstract class BaseVirtualServiceListnerForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('virtual_service_listner[%s]');
